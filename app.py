...
try:
    ...
    print(f"⚠️ Warning: Could not initialize MongoDB on startup: {e}")
    print("💡 MongoDB will be initialized on first request")

if __name__ == '__main__':
    # Ensure MongoDB is connected for direct execution
    if not init_mongodb():
